...
// <div style={{ fontWeight: 600, marginBottom: 12 , color: darkMode ? "#f6f6f6" : "#181818"} }>
//   Expenses by Category
// </div>            {expenseByCategory.length === 0 ? (
...
// const COLORS = [
//   "#00C49F", "#FF8042", "#FFBB28", "#0088FE",
//   "#FF6384", "#36A2EB", "#FFCE56", "#A28EFF"
// ];
...
//   if (loading)
//     return <div className="dashboard-center-message">Loading dashboard...</div>;
//   if (!user) return null;
...
//             </div>
//           </div>
//           <a href="/budget" className="dashboard-btn dashboard-btn-budget">
//             Budget
//           </a>
//           <a
//             href="http://localhost:5000/logout"
...
//             <div className="dashboard-card-label">Net Balance</div>
//             <div className="dashboard-card-value">{formatCurrency(netBalance)}</div>
//           </div>
//           <div className="dashboard-card">
//             <div className="dashboard-card-label">Total Income</div>
//             <div className="dashboard-card-value income">{formatCurrency(totalIncome)}</div>
//           </div>
//           <div className="dashboard-card">
//             <div className="dashboard-card-label">Total Expense</div>
//             <div className="dashboard-card-value expense">{formatCurrency(totalExpense)}</div>
//           </div>
//           <div className="dashboard-card">
//             <div className="dashboard-card-label">Total Assets</div>
//             <div className="dashboard-card-value asset">{formatCurrency(totalAssets)}</div>
//           </div>
//           <div className="dashboard-card">
//             <div className="dashboard-card-label">Total Liabilities</div>
//             <div className="dashboard-card-value liability">{formatCurrency(totalLiabilities)}</div>
//           </div>
//           <div className="dashboard-card">
//             <div className="dashboard-card-label">Net Worth</div>
//             <div className="dashboard-card-value networth">{formatCurrency(netWorth)}</div>
//           </div>
//         </div>
...
//             <div className="dashboard-chart-title">Expenses by Category</div>
//             {expenseByCategory.length === 0 ? (
//               <div className="dashboard-no-data">No expenses yet.</div>
//             ) : (
//               <ResponsiveContainer width="100%" height={220}>
//                 <PieChart>
//                   <Pie
...
//           <h3 className="dashboard-section-title">Assets</h3>
//           {/* ...form for adding asset... */}
//           <form onSubmit={handleAddAsset} style={{ display: "flex", gap: 18, marginBottom: 12, flexWrap: "wrap" }}>
//              <input
//               type="text"
//               name="name"
...
//                   <tr key={a._id}>
//                     <td>{a.name}</td>
//                     <td className="asset">{formatCurrency(a.value)}</td>
...
//         <div className="dashboard-section">
//           <h3 className="dashboard-section-title">Liabilities</h3>
//           {/* ...form for adding liability... */}
//           <form onSubmit={handleAddLiability} style={{ display: "flex", gap: 18, marginBottom: 12, flexWrap: "wrap" }}>
//             <input
//               type="text"
//               name="name"
...
//                   <tr key={l._id}>
//                     <td>{l.name}</td>
//                     <td className="liability">{formatCurrency(l.value)}</td>
